...
@interface PublishPersonnelController ()<UIActionSheetDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UITextFieldDelegate,UITextViewDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UIScrollViewDelegate>
...
- (void)viewDidLoad {
    ...
    UISwipeGestureRecognizer * SW = [[UISwipeGestureRecognizer alloc]initWithTarget:self action:@selector(HED)];
    [self.tableView addGestureRecognizer:SW];
    if (self.desModel) {
