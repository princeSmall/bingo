...
- (void)createBottomComfirmBtn
{
    ...
    UIButton *comfirmBtn = [DeliveryUtility createBtnFrame:CGRectMake(20,20,kViewWidth-40,40) title:@"确认" andFont:[UIFont systemFontOfSize:17.0f] target:self action:@selector(comfirmSetingMineInfo:)];
