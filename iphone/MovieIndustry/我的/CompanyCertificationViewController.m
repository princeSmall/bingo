...
@interface CompanyCertificationViewController ()
...
//    self.view.backgroundColor = RGBColor(234, 234, 234, 1);
    ...
    CertificationScrollView *scrollView = [[CertificationScrollView alloc]initWithFrame:CGRectMake(0, lineView.frame.size.height+lineView.frame.origin.y, self.view.frame.size.width, self.view.frame.size.height-(lineView.frame.size.height+lineView.frame.origin.y)) title:@"公司认证"];
