...
//                if(method ==nil)
//                {
//                    method = modelGood.goods_express;
//                }
//                else
//                {
//                    if([method isEqualToString:modelGood.goods_express])
//                    {
//                        [DeliveryUtility showMessage:@"请选择送货方式一致的商品" target:self];
//                        return;
//                    }
//                }
//            }
...
//                detail.order_id = result[@"data"];
            ...
            CartGood *goods =detail.goodsInfoArray[0];
            detail.method = goods.goods_express;
            cat_id = nil;
