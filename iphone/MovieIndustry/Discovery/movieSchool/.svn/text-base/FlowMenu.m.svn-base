...
@interface FlowMenu() <UIScrollViewDelegate>
...
- (void)setFatherController:(MovieClassesController *)fatherController {
...
- (void)confingTopView{
    ...
    self.slideView = [[UIView alloc] initWithFrame:CGRectMake(0, KTopViewHight - 4, buttonWight, 4)];
    
    [_slideView setBackgroundColor:[UIColor colorWithPatternImage:[UIImage imageNamed:@"tab_kechengfenlei"]]];
