...
- (CGSize)sizeForString:(NSString *)string font:(UIFont *)font constrainedToSize:(CGSize)constrainedSize lineBreakMode:(NSLineBreakMode)lineBreakMode {
    ...
    return [string boundingRectWithSize:constrainedSize options:NSStringDrawingUsesLineFragmentOrigin attributes:attrDict context:nil].size;
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (CSToastDisplayShadow) {
        ...
        wrapperView.layer.shadowColor = [UIColor colorWithRed:(202.0/255.0) green:(202.0/255.0) blue:(202.0/255.0) alpha:1].CGColor;
//        wrapperView.layer.shadowColor = [UIColor blackColor].CGColor;
    ...
    wrapperView.backgroundColor = [[UIColor colorWithRed:(202.0/255.0) green:(202.0/255.0) blue:(202.0/255.0) alpha:1]colorWithAlphaComponent:CSToastOpacity];
