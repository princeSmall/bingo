...
#import "MovieMineIssueRequestModel.h"
...
@interface MovieMineIssueRequestModel ()

- (id)objectOrNilForKey:(id)aKey fromDictionary:(NSDictionary *)dict;

@end

@implementation MovieMineIssueRequestModel

@synthesize movieMineIssueRequestModelIdentifier = _movieMineIssueRequestModelIdentifier;
...
- (instancetype)initWithDictionary:(NSDictionary *)dict
{
    ...
    if(self && [dict isKindOfClass:[NSDictionary class]]) {
            self.movieMineIssueRequestModelIdentifier = [self objectOrNilForKey:kMovieMineIssueRequestModelId fromDictionary:dict];
...
- (NSDictionary *)dictionaryRepresentation
{
    ...
    [mutableDict setValue:self.movieMineIssueRequestModelIdentifier forKey:kMovieMineIssueRequestModelId];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    self.movieMineIssueRequestModelIdentifier = [aDecoder decodeObjectForKey:kMovieMineIssueRequestModelId];
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:_movieMineIssueRequestModelIdentifier forKey:kMovieMineIssueRequestModelId];
...
{
    MovieMineIssueRequestModel *copy = [[MovieMineIssueRequestModel alloc] init];
    
    if (copy) {

        copy.movieMineIssueRequestModelIdentifier = [self.movieMineIssueRequestModelIdentifier copyWithZone:zone];
